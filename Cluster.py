...
# Folders to analyse:
root_path=r"/Users/Mathew/Documents/Current analysis/Craig files/"
pathList=[]
...
pathList.append(r"/Users/Mathew/Documents/Current analysis/Craig files/")
...
for path in pathList:
    ...
    if to_cluster==1:
        ...
        if len(cluster_contents)>0:
            ...
            measurements.to_csv(path + 'Metrics_40.csv', sep = '\t')
        ...
        if to_cluster==1:
            Output_all_cases.to_csv(root_path + 'GDSC_all_metrics_60.csv', sep = '\t')
